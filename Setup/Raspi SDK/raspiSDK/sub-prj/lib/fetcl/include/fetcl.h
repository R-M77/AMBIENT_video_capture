...
#define FETCL_USER_ABORT						-4280	// APDU cancelled by user



// defines for uiFlag in FETCL_EVENT_INIT
#define FETCL_THREAD_ID			1 // discontinued
#define FETCL_WND_HWND			2 // discontinued
...
int DLL_EXT_FUNC FETCL_CancelApdu(	int iTransponderHnd );
...
int DLL_EXT_FUNC FETCL_GetIsoErrorCode( int iTransponderHnd );
