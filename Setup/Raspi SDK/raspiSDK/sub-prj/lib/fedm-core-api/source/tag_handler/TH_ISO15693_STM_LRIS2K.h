...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_STM_LRIS2K_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_STM_LRIS2K_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		namespace TagHandler
		{
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO15693_STM_LRIS2K : public TH_ISO15693_STM
			{
			...
			public:
				...
				/// <b>Description</b><br>
				/// Refer to the Application Note <i>STMicroelectronics Custom and Proprietary Commands.pdf</i>, where all parameters are described in detail.
				int WritePassword(unsigned char ucPasswordNumber, std::string sPassword);
				...
				/// <b>Description</b><br>
				/// Refer to the Application Note <i>STMicroelectronics Custom and Proprietary Commands.pdf</i>, where all parameters are described in detail.
				int PresentPassword(unsigned char ucPasswordNumber, std::string sPassword);

			protected:
				// constructor
				TH_ISO15693_STM_LRIS2K(ReaderModule* pReader, FedmIscTagHandler_ISO15693_STM_LRIS2K* pThImpl);
				// destructor
				virtual ~TH_ISO15693_STM_LRIS2K();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_STM_LRIS2K_H_INCLUDED_)
