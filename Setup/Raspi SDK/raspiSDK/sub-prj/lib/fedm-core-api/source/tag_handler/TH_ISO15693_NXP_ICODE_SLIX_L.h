...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_NXP_ICODE_SLIX_L_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_NXP_ICODE_SLIX_L_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		{
			//####################################################################
			// class TH_ISO15693_NXP_ICODE_SLIX_L
			...
			/// All methods are similiar to specific commands of I-CODE SLIX-L. Thus, you must refer to the Technical Datasheet of the I-CODE SLIX-L to get detailed information about the methods and the parameters.<br>
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO15693_NXP_ICODE_SLIX_L : public TH_ISO15693_NXP_ICODE_SLI_L
			{
			...
			protected:
				// constructor
				TH_ISO15693_NXP_ICODE_SLIX_L(ReaderModule* pReader, FedmIscTagHandler_ISO15693_NXP_ICODE_SLIX_L* pThImpl);
				// destructor
				virtual ~TH_ISO15693_NXP_ICODE_SLIX_L();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_NXP_ICODE_SLIX_L_H_INCLUDED_)
