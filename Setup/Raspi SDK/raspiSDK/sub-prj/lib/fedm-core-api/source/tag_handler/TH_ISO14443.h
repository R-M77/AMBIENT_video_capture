...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		namespace TagHandler
		{
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO14443 : public TH_Base
			{
			...
			public:
				...
				///
				/// <b>Description</b><br>
				/// The Manufacturer Name is specified with Manufcturer Code, which is located in byte 7 or byte 9 of the IDD
				std::string GetManufacturerName();

			protected:
				// constructor
				TH_ISO14443(ReaderModule* pReader, FedmIscTagHandler_ISO14443* pThImpl);
				// destructor
				virtual ~TH_ISO14443();
