...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_3_MIFARE_PLUS_SL2_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_3_MIFARE_PLUS_SL2_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		{
			//####################################################################
			// class TH_ISO14443_3_MIFARE_Plus_SL2
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO14443_3_MIFARE_Plus_SL2 : public TH_ISO14443_3_MIFARE_Plus
			{
			...
			protected:
				// constructor
				TH_ISO14443_3_MIFARE_Plus_SL2(ReaderModule* pReader, FedmIscTagHandler_ISO14443_3_MIFARE_Plus_SL2* pThImpl);
				// destructor
				virtual ~TH_ISO14443_3_MIFARE_Plus_SL2();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_3_MIFARE_PLUS_SL2_H_INCLUDED_)
