...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_EM_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_EM_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		namespace TagHandler
		{
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO15693_EM : public TH_ISO15693
			{
			...
			protected:
				// constructor
				TH_ISO15693_EM(ReaderModule* pReader, FedmIscTagHandler_ISO15693_EM* pThImpl);
				// destructor
				virtual ~TH_ISO15693_EM();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_EM_H_INCLUDED_)
