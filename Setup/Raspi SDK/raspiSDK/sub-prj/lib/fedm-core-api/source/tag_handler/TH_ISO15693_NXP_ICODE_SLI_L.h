...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_NXP_ICODE_SLI_L_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_NXP_ICODE_SLI_L_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		{
			//####################################################################
			// class TH_ISO15693_NXP_ICODE_SLI_L
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO15693_NXP_ICODE_SLI_L : public TH_ISO15693_NXP_ICODE_SLI
			{
			...
			public:
				...
				/// <b>Description</b><br>
				/// Refer to the Application Note <i>NXP Custom and Proprietary Commands.pdf</i>, where all parameters are described in detail.
				int WriteEASID(std::string sEASID);
			...
			protected:
				// constructor
				TH_ISO15693_NXP_ICODE_SLI_L(ReaderModule* pReader, FedmIscTagHandler_ISO15693_NXP_ICODE_SLI_L* pThImpl);
				// destructor
				virtual ~TH_ISO15693_NXP_ICODE_SLI_L();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_NXP_ICODE_SLI_L_H_INCLUDED_)
