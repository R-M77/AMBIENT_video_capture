...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_4_MIFARE_DESFIRE_SAM_CRYPTO_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_4_MIFARE_DESFIRE_SAM_CRYPTO_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		{
			//####################################################################
			// class TH_ISO14443_4_MIFARE_DESFire_SamCrypto
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO14443_4_MIFARE_DESFire_SamCrypto
			{
			...
			protected:
				// constructor
				TH_ISO14443_4_MIFARE_DESFire_SamCrypto();
				// destructor
				virtual ~TH_ISO14443_4_MIFARE_DESFire_SamCrypto();

				FedmIscTagHandler_ISO14443_4_MIFARE_DESFire_SamCrypto* m_pImpl;
			};
		}
	}
}
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_4_MIFARE_DESFIRE_SAM_CRYPTO_H_INCLUDED_)
