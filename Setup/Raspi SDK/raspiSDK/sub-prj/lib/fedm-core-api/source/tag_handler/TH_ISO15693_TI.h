...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_TI_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_TI_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		namespace TagHandler
		{
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO15693_TI : public TH_ISO15693
			{
			...
			protected:
				// constructor
				TH_ISO15693_TI(ReaderModule* pReader, FedmIscTagHandler_ISO15693_TI* pThImpl);
				// destructor
				virtual ~TH_ISO15693_TI();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO15693_TI_H_INCLUDED_)
