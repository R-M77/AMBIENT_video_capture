...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_4_MIFARE_PLUS_SL1_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_4_MIFARE_PLUS_SL1_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		{
			//####################################################################
			// class TH_ISO14443_4_MIFARE_Plus_SL1
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO14443_4_MIFARE_Plus_SL1 : public TH_ISO14443_4_MIFARE_Plus
			{
			...
			protected:
				// constructor
				TH_ISO14443_4_MIFARE_Plus_SL1(ReaderModule* pReader, FedmIscTagHandler_ISO14443_4_MIFARE_Plus_SL1* pThImpl);
				// destructor
				virtual ~TH_ISO14443_4_MIFARE_Plus_SL1();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_4_MIFARE_PLUS_SL1_H_INCLUDED_)
