...
#if !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_2_STM_SRIXXX_H_INCLUDED_)
#define _FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_2_STM_SRIXXX_H_INCLUDED_
...
namespace FEDM
{
	namespace Core
	{
		...
		{
			//####################################################################
			// class TH_ISO14443_2_STM_SRIxxx
			...
			class _FEDM_ISC_CORE_EXT_CLASS TH_ISO14443_2_STM_SRIxxx : public TH_ISO14443_2
			{
			...
			protected:
				// constructor
				TH_ISO14443_2_STM_SRIxxx(ReaderModule* pReader, FedmIscTagHandler_ISO14443_2_STM_SRIxxx* pThImpl);
				// destructor
				virtual ~TH_ISO14443_2_STM_SRIxxx();
...
#endif // !defined(_FEDM_CORE_ISCAN_TAG_HANDLER_TH_ISO14443_2_STM_SRIXXX_H_INCLUDED_)
