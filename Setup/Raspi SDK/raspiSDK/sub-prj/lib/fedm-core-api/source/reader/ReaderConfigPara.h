...
This software is the confidential and proprietary information of FEIG ELECTRONIC GmbH ("Confidential Information").
You shall not disclose such Confidential Information and shall use it only in accordance with the terms of the license agreement you entered
...
#if !defined(_FEDM_CORE_READER_CONFIG_PARA_H_INCLUDED_)
#define _FEDM_CORE_READER_CONFIG_PARA_H_INCLUDED_
...
#endif // _FEDM_CORE_READER_CONFIG_PARA_H_INCLUDED_
