...
#define FETCP_ERR_UNSUPPORTED				-1206
...
#define FETCP_THREAD_ID		1 // discontinued
#define FETCP_WND_HWND		2 // discontinued
...
typedef struct _FETCP_EVENT_INIT
{
	...
	unsigned int uiUse;		// defines the event (e.g. FETCP_DEV_DISCONNECT_EVENT)
	unsigned int uiMsg;		// RFU
	unsigned int uiFlag;	// specifies the use of the union (e.g. FETCP_CALLBACK)
	union
	{
		// callback-function
