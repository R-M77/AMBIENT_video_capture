...
public:
	...
	// serialization helper functions for file-header version 1.2
	virtual int SerializeHeaderOut(FEDM_XML_TREEITEM* parent, const char* szVendor="");

	// serialization helper functions for file-header version 2.0
	int SerializeHeaderOutV2(FEDM_XML_TREEITEM* parent, const char* szVendor="");
