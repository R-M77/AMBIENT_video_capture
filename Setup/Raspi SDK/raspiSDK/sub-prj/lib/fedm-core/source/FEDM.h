...
#define	FEDM_ERROR_TAG_HANDLER_NOT_FOUND			-159
#define FEDM_ERROR_DATA_LENGTH                      -160
...
#define FEDM_COMM_MODE_EMULATOR		0x0004
...
#define FEDM_CNTRL_TYPE_LEDC			9	// LED Controller
#define FEDM_CNTRL_TYPE_UPCC			10	// UHF People Counter Controller
#define FEDM_CNTRL_TYPE_BC_ENGINE		11	// Barcode Engine
#define FEDM_CNTRL_TYPE_MLC_EMPS_LS200			0x00060011	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_LS300			0x00060020	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_LS400			0x00060021	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_DS200_KNOB		0x00060031	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_DS300_KNOB		0x00060032	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_DS400_KNOB		0x00060033	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_DS200_HANDLE	0x00060041	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_DS300_HANDLE	0x00060042	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_EMPS_DS400_HANDLE	0x00060043	// megalock C Lock (obsolete)
#define FEDM_CNTRL_TYPE_MLC_WS_LS200			0x00060061	// megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_LS300			0x00060062	// megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_LS400			0x00060063	// megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_DS200_HANDLE		0x00060071	// megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_DS300_HANDLE		0x00060072	// megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_DS400_HANDLE		0x00060073	// megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_WS200			0x00060001  // megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_WS300			0x00060002  // megalock C Lock
#define FEDM_CNTRL_TYPE_MLC_WS_WS400			0x00060003  // megalock C Lock
...
#define FEDM_IS_EMUPORT(iPortHnd)	((iPortHnd&0x40000000)&&(iPortHnd>0))
...
// Parameter of the next macro must be of typ JNIEnv*
// ...jvm->AttachCurrentThread(FEDM_JNIENV(env), ...
#if defined(_FEDM_LINUX) && defined(_FEDM_ANDROID)
#define FEDM_JNIENV(jniEnvPtr) (&(jniEnvPtr))
#else
#define FEDM_JNIENV(jniEnvPtr) ((void **)&(jniEnvPtr))
#endif
