...
Copyright © 2000-2016	FEIG ELECTRONIC GmbH, All Rights Reserved.
						Lange Strasse 4
						D-35781 Weilburg
...
Version       		:	04.07.00 / 15.09.2016 / M. Hultsch
						- new constants in block 86-89 for [0xB5] ISO 14443 NXP Custom Commands

						04.06.14 / 23.11.2015 / M. Hultsch
						- new constants in block 29 for [0xB3] EPC Class1 Gen2 Commands

						04.06.11 / 15.12.2014 / M. Hultsch
						- new constants in block 29 for [0xB3] EPC Class1 Gen2 Commands

						04.06.10 / 02.12.2014 / M. Hultsch
...
#define FEDM_ISC_TMP_0xA4_MODE							"03 10 02 20 01 00 00"	// mode in [0xA4]
#define FEDM_ISC_TMP_0xA4_PRIV_LEVEL					"03 10 02 21 01 00 00"	// privilege level in [0xA4]
...
#define FEDM_ISC_TMP_0x3A_MODE							"03 10 03 17 01 00 00"	// MODE parameter in [0x3A] Adjust Auto Read Mode
#define FEDM_ISC_TMP_0x3A_DATA_SELECTOR					"03 10 03 18 04 00 00"	// parameter in [0x3A] Adjust Auto Read Mode
#define FEDM_ISC_TMP_0x3A_SCAN_ENGINE					"03 10 03 22 02 00 00"	// parameter in [0x3A] Adjust Auto Read Mode
...
#define FEDM_ISC_TMP_SOFTVER_READER_REVISION			"03 10 05 13 01 00 00"	// reader revision value in [0x66], Mode 0
#define FEDM_ISC_TMP_SOFTVER_READER_ASSEMBLY			"03 10 05 14 01 00 00"	// reader assembly value in [0x66], Mode 0
#define FEDM_ISC_TMP_SOFTVER_READER_PRT_FRM_SUPPORT		"03 10 05 15 01 00 00"	// protocol frame support in [0x66], Mode 0
#define FEDM_ISC_TMP_SOFTVER_READER_CFG_ID				"03 10 05 16 04 00 00"	// configuration ID in [0x66], Mode 0
...
#define FEDM_ISC_TMP_B0_MODE_TAG_TYPE_LIST				"03 10 08 01 01 03 01" // only for [0xB0][0x01] Inventory with optional Tag Type List
...
#define FEDM_ISC_TMP_B0_REQ_TR_TYPE_NO					"03 10 10 11 01 00 00" // only for [0xB0][0x01] Inventory with optional Tag Type List
#define FEDM_ISC_TMP_B0_REQ_TR_TYPE_LIST_NO1			"03 10 10 12 01 00 00" // only for [0xB0][0x01] Inventory with optional Tag Type List
#define FEDM_ISC_TMP_B0_REQ_TR_TYPE_LIST_NO2			"03 10 10 13 01 00 00" // only for [0xB0][0x01] Inventory with optional Tag Type List
...
#define FEDM_ISC_TMP_B3_RSP_DATA_LEN					"03 10 28 27 01 00 00"
														
// block 29: [0xB3] send data							 FF-MM-BN-BY-NB-BI-Nb
#define FEDM_ISC_TMP_B3_REQ_UFLAG						"03 10 29 00 01 00 00"
#define FEDM_ISC_TMP_B3_REQ_HIDE						"03 10 29 01 02 00 00"
#define FEDM_ISC_TMP_B3_REQ_HIDE_NEW_EPC_LEN			"03 10 29 01 01 00 05"
#define FEDM_ISC_TMP_B3_REQ_HIDE_EPC					"03 10 29 01 01 05 01"
#define FEDM_ISC_TMP_B3_REQ_HIDE_USER					"03 10 29 02 01 00 01"
#define FEDM_ISC_TMP_B3_REQ_HIDE_TID					"03 10 29 02 01 01 02"
#define FEDM_ISC_TMP_B3_REQ_RANGE						"03 10 29 03 01 00 00"
#define FEDM_ISC_TMP_B3_REQ_RESP_FLAG					"03 10 29 04 01 00 00"
#define FEDM_ISC_TMP_B3_REQ_RESP_FLAG_INC_REP_LEN		"03 10 29 04 01 00 01"
#define FEDM_ISC_TMP_B3_REQ_RESP_FLAG_SEN_REP			"03 10 29 04 01 01 01"
#define FEDM_ISC_TMP_B3_REQ_TAM							"03 10 29 05 01 00 00"
#define FEDM_ISC_TMP_B3_REQ_KEY_ID						"03 10 29 06 01 00 00"
#define FEDM_ISC_TMP_B3_REQ_KEY_ID_KEY_TYPE				"03 10 29 06 01 00 03"
#define FEDM_ISC_TMP_B3_REQ_KEY_ID_KEY_LOC				"03 10 29 06 01 07 01"
#define FEDM_ISC_TMP_B3_REQ_PROFILE						"03 10 29 07 01 00 00"
#define FEDM_ISC_TMP_B3_REQ_OFFSET						"03 10 29 08 02 00 00"
#define FEDM_ISC_TMP_B3_REQ_BLOCK_COUNT					"03 10 29 10 01 00 00"
#define FEDM_ISC_TMP_B3_REQ_PROT_MODE					"03 10 29 11 01 00 00"
...
#define FEDM_ISC_TMP_B4_REQ_NXP_KEY_TYPE				"03 10 37 12 01 00 00"
...
#define FEDM_ISC_TMP_B4_REQ_EM_SPI_DELAY_TIME_INITIAL	"03 10 46 04 01 02 02"
#define FEDM_ISC_TMP_B4_REQ_EM_SPI_DELAY_TIME_BYTE		"03 10 46 04 01 00 02"
...
// block 51: [0xA1], [0xA4] or [0xAE] send data			 FF-MM-BN-BY-NB-BI-Nb
#define FEDM_ISC_TMP_USERNAME							"03 10 51 00 16 00 00"	// user name
#define FEDM_ISC_TMP_PASSWORD							"03 10 51 16 16 00 00"	// password

// block 52: [0xA1], [0xA4] string length				 FF-MM-BN-BY-NB-BI-Nb
#define FEDM_ISC_TMP_USERNAME_LEN						"03 10 52 00 01 00 00"	// length of user name
#define FEDM_ISC_TMP_PASSWORD_LEN						"03 10 52 01 01 00 00"	// length of password
...
// block 86: [0xB5] send data							 FF-MM-BN-BY-NB-BI-Nb
#define FEDM_ISC_TMP_0xB5_REQ_CMD						"03 10 86 00 01 00 00"
#define FEDM_ISC_TMP_0xB5_REQ_MFR						"03 10 86 01 01 00 00"
#define FEDM_ISC_TMP_0xB5_REQ_NXP_PWD_AUTH				"03 10 86 02 04 00 00" // for NXP [0x1B]
#define FEDM_ISC_TMP_0xB5_REQ_NXP_READ_CNT_ADR			"03 10 86 06 01 00 00" // for NXP [0x39]
#define FEDM_ISC_TMP_0xB5_REQ_NXP_FAST_READ_START_ADR	"03 10 86 07 01 00 00" // for NXP [0x3A]
#define FEDM_ISC_TMP_0xB5_REQ_NXP_FAST_READ_DB_N		"03 10 86 08 01 00 00" // for NXP [0x3A]
#define FEDM_ISC_TMP_0xB5_REQ_NXP_CTE_ADR				"03 10 86 09 01 00 00" // for NXP [0x3E]
#define FEDM_ISC_TMP_0xB5_REQ_NXP_VCSL_IID				"03 10 86 10 16 00 00" // for NXP [0x4B]
#define FEDM_ISC_TMP_0xB5_REQ_NXP_VCSL_PCDCAPS			"03 10 86 26 04 00 00" // for NXP [0x4B]

// block 87: [0xB5] receive data						 FF-MM-BN-BY-NB-BI-Nb
#define FEDM_ISC_TMP_0xB5_RSP_STATUS					"03 10 87 00 01 00 00"
#define FEDM_ISC_TMP_0xB5_RSP_ISO_ERROR					"03 10 87 01 01 00 00"
#define FEDM_ISC_TMP_0xB5_RSP_NXP_PACK					"03 10 87 02 02 00 00" // for NXP [0x1B]
#define FEDM_ISC_TMP_0xB5_RSP_NXP_READ_CNT_COUNTER		"03 10 87 04 03 00 00" // for NXP [0x39]
#define FEDM_ISC_TMP_0xB5_RSP_NXP_FAST_READ_DB_N		"03 10 87 08 01 00 00" // for NXP [0x3A]
#define FEDM_ISC_TMP_0xB5_RSP_NXP_FAST_READ_DB_SIZE		"03 10 87 09 01 00 00" // for NXP [0x3A]
#define FEDM_ISC_TMP_0xB5_RSP_NXP_CTE_VALID				"03 10 87 10 01 00 00" // for NXP [0x3E]
#define FEDM_ISC_TMP_0xB5_RSP_NXP_VCSL_VCTID			"03 10 87 11 01 00 00" // for NXP [0x4B]
#define FEDM_ISC_TMP_0xB5_RSP_NXP_PROD_INFO				"03 10 87 12 08 00 00" // for NXP [0x60]

// block 88: [0xB5] receive data						 FF-MM-BN-BY-NB-BI-Nb
#define FEDM_ISC_TMP_0xB5_RSP_NXP_READ_SIG				"03 10 88 00 32 00 00" // for NXP [0x3C]

// block 89: [0xB5] send data							 FF-MM-BN-BY-NB-BI-Nb
#define FEDM_ISC_TMP_0xB5_REQ_NXP_INCR_CNT_ADR			"03 10 89 00 01 00 00" // for NXP [0xA5]
#define FEDM_ISC_TMP_0xB5_REQ_NXP_INCR_CNT_INC_VAL		"03 10 89 01 03 00 00" // for NXP [0xA5]
