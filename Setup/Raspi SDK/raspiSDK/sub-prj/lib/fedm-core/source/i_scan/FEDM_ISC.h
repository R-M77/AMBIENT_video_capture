...
Version       		:	04.07.01 / 11.10.2016 / M. Hultsch
						- new reader: ID CPR71
						
						04.07.00 / 15.09.2016 / M. Hultsch
						- new reader: ID CPR74
						
						04.06.06 / 24.09.2014 / M. Hultsch
						- new reader: ID CPR60
...
#define FEDM_ISC_MAX_RFC_EEDATA_MEM		9216	// memory for parameters in readers EEPROM
#define FEDM_ISC_MAX_RFC_RAMDATA_MEM	9216	// memory for parameters in readers RAM
...
#define FEDM_ISC_MAX_SCANNER_ID_LENGTH	  32
...
#define FEDM_ISC_ISO_MODE_TAG_LIST	    		0x08	// only for [0xB0][0x01] Inventory with optional Tag Type List
...
#define FEDM_ISC_TYPE_UNKNOWN           0
...
#define FEDM_ISC_TYPE_ANT_GPC			13	// HF Gate People Counter
#define FEDM_ISC_TYPE_ANT_LED			14	// LED Controller
#define FEDM_ISC_TYPE_ANT_UPC			15	// UHF Gate People Counter
...
//#define FEDM_ISC_TYPE_ISCMR10X			0x00010094 // remove!!

// reader classes
#define FEDM_RDR_CLASS_LRU500_I			95 // <<-- this is a family type and not a reader type !!
...
#define FEDM_ISC_TYPE_CPR74            114
#define FEDM_ISC_TYPE_CPR71            115
...
#define FEDM_RDR_TYPE_MAXU500_I        (FEDM_RDR_CLASS_LRU500_I | (0x03 << 8))

// UHF reader types
#define FEDM_ISC_TYPE_ISCMU02			50
#define FEDM_ISC_TYPE_ISCMU95			51
#define FEDM_ISC_TYPE_ISCMU92			52
...
#define FEDM_RDR_TYPE_LRU500_I_BD       (FEDM_RDR_CLASS_LRU500_I | (0x01 << 8))
#define FEDM_RDR_TYPE_LRU500_I_POE      (FEDM_RDR_CLASS_LRU500_I | (0x02 << 8))
...
// UHF gates
#define FEDM_ISC_TYPE_ANTU_500_270_GA  130
#define FEDM_ISC_TYPE_ANTU_500_270_DM  131

// Wearables
#define FEDM_TYPE_HYWEAR_COMPACT		140
#define FEDM_TYPE_ECCO_PLUS				141
#define FEDM_RDR_CLASS_ECCO_SMART		142 // <<-- this is a family type and not a reader type !!
#define FEDM_TYPE_HYWEAR_COMPACT_XT		(FEDM_TYPE_HYWEAR_COMPACT | (0x01 << 8))
#define FEDM_TYPE_HYWEAR_COMPACT_SR		(FEDM_TYPE_HYWEAR_COMPACT | (0x02 << 8))
#define FEDM_TYPE_ECCO_SMART_HF_BLE		(FEDM_RDR_CLASS_ECCO_SMART | (0x01 << 8))
#define FEDM_TYPE_ECCO_SMART_2D_HF_BLE	(FEDM_RDR_CLASS_ECCO_SMART | (0x02 << 8))



// name of readers
#define FEDM_ISC_NAME_ANT_DAT			"ID ISC.DAT"	// HF Dynamic Antenna Tuner
#define FEDM_ISC_NAME_ANT_UMUX			"ID ISC.UMUX"	// UHF Antenna Multiplexer
#define FEDM_ISC_NAME_ANT_GPC			"ID ISC.ANT.GPC"	// HF Gate People Counter
#define FEDM_ISC_NAME_ANT_LED			"ID ISC.ANT.LED"	// LED-Controller
#define FEDM_ISC_NAME_ANT_UPC			"ID ISC.ANT.UPC"	// UHF Gate People Counter
...
#define FEDM_ISC_NAME_OEM1				"ID OEM1"

// experimental reader, identified by reader class, class generation and reader type
//#define FEDM_ISC_NAME_ISCMR10X			"OBID i-scan HF Mid-Range Type 1" // remove!!
...
#define FEDM_ISC_NAME_CPR74 			"ID CPR74"
#define FEDM_ISC_NAME_CPR71 			"ID CPR71"
...
#define FEDM_RDR_NAME_MAXU500_I			"ID MAX.U500i"

#define FEDM_ISC_NAME_ISCMU02			"ID ISC.MU02"			// UHF
#define FEDM_ISC_NAME_ISCMU92			"ID ISC.MU92"			// UHF
...
#define FEDM_RDR_NAME_LRU500_I_BD       "ID LRU500i-BD"			// UHF
#define FEDM_RDR_NAME_LRU500_I_POE      "ID LRU500i-PoE"		// UHF

#define FEDM_ISC_NAME_MLC_COM			"ID MLC.COM"
#define FEDM_ISC_NAME_MLC_EMPS			"ID MLC.EMPS"

// UHF gates
#define FEDM_ISC_NAME_ANTU_500_270_GA	"ID ISC.ANT.U500/270-GA"
#define FEDM_ISC_NAME_ANTU_500_270_DM	"ID ISC.ANT.U500/270-DM"

// Wearables
#define FEDM_NAME_HYWEAR_COMPACT		"ID HyWEAR compact"
#define FEDM_NAME_HYWEAR_COMPACT_XT		"ID HyWEAR compact xT"
#define FEDM_NAME_HYWEAR_COMPACT_SR		"ID HyWEAR compact sR"
#define FEDM_NAME_ECCO_PLUS				"ID ECCO+"
#define FEDM_NAME_ECCO_SMART			"ID ECCO Smart" // <<-- this is a family name and not a reader name !!
														// <<-- It can be used for collective actions in an application

#define FEDM_NAME_ECCO_SMART_HF_BLE		"ID ECCO Smart HF-BLE"
#define FEDM_NAME_ECCO_SMART_2D_HF_BLE	"ID ECCO Smart 2D-HF-BLE"
...
#define FEDM_ISC_NAME_ANT_GPC_UC		L"ID ANT.GPC"	// HF Gate People Counter
#define FEDM_ISC_NAME_ANT_UPC_UC		L"ID ANT.UPC"	// UHF Gate People Counter
...
#define FEDM_ISC_NAME_CPR74_UC   		L"ID CPR74"
#define FEDM_ISC_NAME_CPR71_UC   		L"ID CPR71"
...
#define FEDM_ISC_TR_TYPE_UNKNOWN            0xFF
...
#define FEDM_ISC_TR_TYPE_FELICA				0x0D
...
// PANMOBIL types
#define FEDM_PAN_TYPE_BARCODE				0xC2
...
#define FEDM_ISC_TR_NAME_FELICA				"Sony FeliCa"
