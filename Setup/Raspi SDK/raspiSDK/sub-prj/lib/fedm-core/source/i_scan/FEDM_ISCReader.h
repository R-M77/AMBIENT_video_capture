...
Version       		:	04.07.01 / 11.10.2016 / M. Hultsch
						- new reader: ID CPR71
						- bugfix in FEDM_Base::SetData(.., unsigned int, ..) for setting only a bit
...
public:
	...
	void Init(); // reset of all internal members to default
	...
	unsigned int GetReaderClass(unsigned int uiReaderType);
...
//	unsigned int GetNonAddressedTabIndex()							{ return m_uiNonAddressedTabIndex; }
	...
	// only for internal use: save data in BRM-table after [0x21] or [0x22] read buffer
...
protected:
	...
	void BuildAccessIdMap_CPR71();
	void BuildAccessIdMap_CPR74();
	...
	void BuildAccessIdMap_MAXU500i();
	void BuildAccessIdMap_MAXU500i_Part0();
	void BuildAccessIdMap_MAXU500i_Part1();
	void BuildAccessIdMap_LRU500i_BD();
	void BuildAccessIdMap_LRU500i_PoE();
	void BuildAccessIdMap_LRU500i_PoE_Part0();
	void BuildAccessIdMap_LRU500i_PoE_Part1();
	...
	void BuildAccessIdMap_LRU3000_Part2();
	void BuildAccessIdMap_ANTU500270GA();
	void BuildAccessIdMap_ANTU500270DM();
	void BuildAccessIdMap_HYWEAR_COMP();
	void BuildAccessIdMap_HYWEAR_COMP_XT();
	void BuildAccessIdMap_HYWEAR_COMP_Part0();
	void BuildAccessIdMap_HYWEAR_COMP_Part1();
	void BuildAccessIdMap_HYWEAR_COMP_SR();
	void BuildAccessIdMap_HYWEAR_COMP_SR_Part0();
	void BuildAccessIdMap_HYWEAR_COMP_SR_Part1();
	void BuildAccessIdMap_ECCO_SMART_HF_BLE();
	void BuildAccessIdMap_ECCO_SMART_2D_HF_BLE();
	...
	virtual int Get_0xB3_0x24_IsoTableData(unsigned char* ucData, int iByteCnt, int iTableIdx);
	virtual int Get_0xB3_0x25_IsoTableData(unsigned char* ucData, int iByteCnt);
	virtual int Get_0xB3_0x26_IsoTableData(unsigned char* ucData, int iByteCnt);
...
//	int Set_0xB4_IsoTableData_IDS(unsigned char ucCmdByte, unsigned char* ucData, int iLen);
	...
	// get data for [0xB5] iso command
	virtual int Get_0xB5_IsoTableData(unsigned char ucCmdByte, unsigned char* ucData);
	int Get_0xB5_IsoTableData_NXP(unsigned char ucCmdByte, unsigned char* ucData);

	// save data in ISO-table after [0xB5][0x??] iso command
	int Set_0xB5_IsoTableData(unsigned char ucCmdByte, unsigned char* ucData, int iLen);
	int Set_0xB5_IsoTableData_NXP(unsigned char ucCmdByte, unsigned char* ucData, int iLen);
