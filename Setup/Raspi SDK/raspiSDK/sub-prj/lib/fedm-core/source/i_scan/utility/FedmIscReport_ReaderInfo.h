...
Version       		:	04.06.14 / 28.08.2015 / M. Hultsch
...
protected:
	...
	virtual void Add0x0AInfoText(string& sReport, bool bSingle=true);
	virtual void Add0x0BInfoText(string& sReport, bool bSingle=true);
	...
	virtual void Add0x15InfoText(string& sReport, bool bSingle=true);
	virtual void Add0x16InfoText(string& sReport, bool bSingle=true);
	...
	virtual void Add0x58InfoText(string& sReport, bool bSingle = true);
	...
	virtual void Add0x81InfoText(string& sReport, bool bSingle = true);
