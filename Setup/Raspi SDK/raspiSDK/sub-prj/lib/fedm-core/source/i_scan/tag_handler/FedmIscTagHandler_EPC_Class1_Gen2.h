...
//	virtual void Init();					// set all data members to 0
	...
	///
	/// <b>Description</b><br>
	/// [0xB3][0x30] Untraceable: This command hides parts of the tag’s TID, EPC and/or user memory.
	...
	///
	/// <b>Description</b><br>
	/// [0xB3][0x31] Authenticate: This command performs tag, reader, or mutual authentication.
	...
	///
	/// <b>Description</b><br>
	/// [0xB3][0x32]Challenge: This command allows an interrogator to instruct multiple tags to simultaneously yet independently precompute and store a cryptographic value.
