...
// #####################################################
#define FECOM_THREAD_ID				1 // discontinued
#define FECOM_WND_HWND				2 // discontinued
#define FECOM_CALLBACK				3
#define FECOM_EVENT					4 // discontinued
...
typedef struct _FECOM_EVENT_INIT
{
	...
	unsigned int uiFlag;	// specifies the use of the union (e.g. FECOM_CALLBACK)
	union
	{
