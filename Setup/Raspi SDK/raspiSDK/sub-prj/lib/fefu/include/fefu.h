...
// communication functions for multiplexer
void DLL_EXT_FUNC FEFU_MUX_SetRepeatParam( int iMaxRepeat, int iDelay );
...
// communication functions for antenna tuner
void DLL_EXT_FUNC FEFU_DAT_SetRepeatParam( int iMaxRepeat, int iDelay );
...
void DLL_EXT_FUNC FEFU_UMUX_SetRepeatParam( int iMaxRepeat, int iDelay );
